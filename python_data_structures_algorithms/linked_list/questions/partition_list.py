    ...
    def partition_list(self, x):
        ...
        while cur:
            ...
            if cur is not None:
                nxt = cur.next
        # Connect partitions
        if dummyHead1 is not None:
            dummyTail1.next = dummyHead2
            self.head = dummyHead1
        elif dummyHead2 is not None:
            self.head = dummyHead2
        # Update Tail
        if dummyTail1 is not None and dummyTail2 is not None:
            dummyTail2.next = None
            self.tail = dummyTail2
